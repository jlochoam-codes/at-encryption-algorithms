    ...
    public void testDesImplementation() {
        ...
        assertDoesNotThrow(
                () -> {
                    ...
                    byte[] cipherText1 = DES.encrypt(PLAIN_TEXT_1);
                    BufferedWriter cipherText1FileWriter = Files.newBufferedWriter(
                            Paths.get(DES.FILES_PATH + "cipherText1.txt"));
                    ...
                    String decryptedText1 = DES.decrypt(cipherText1FromFile);
                    BufferedWriter decryptedText1FileWriter = Files.newBufferedWriter(
                            Paths.get(DES.FILES_PATH + "decryptedText1.txt"));
                    ...
                    byte[] cipherText2 = DES.encrypt(PLAIN_TEXT_2);
                    BufferedWriter cipherText2FileWriter = Files.newBufferedWriter(
                            Paths.get(DES.FILES_PATH + "cipherText2.txt"));
                    ...
                    String decryptedText2 = DES.decrypt(cipherText2FromFile);
                    BufferedWriter decryptedText2FileWriter = Files.newBufferedWriter(
                            Paths.get(DES.FILES_PATH + "decryptedText2.txt"));
